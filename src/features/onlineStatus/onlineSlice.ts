...
import { addNotification, Notification } from "../notifications/notificationsSlice";
...
export const updateOnlineStatus = (online: boolean): AppThunk => async (dispatch, getState) => {
