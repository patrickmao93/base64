...
export const ReposSortButton = (props: Props) => {
  ...
  return (
    <>
      <Button className={props.className} size="small" color="primary" onClick={handleClick}>
        Remove All
      </Button>
      <RemoveAllDialog open={openDialog} handleCancel={handleDialogCancel} handleOK={handleDialogOK} />
    </>
  );
};
