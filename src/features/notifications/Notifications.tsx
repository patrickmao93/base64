...
const Notifications = () => {
  ...
  const current = useSelector((state: RootState) => state.notifications.current);
  ...
  return (
    <div>
      ...
      >
        <Alert onClose={handleClose} variant="filled" severity={current && current.type ? current.type : "info"}>
          {current?.message}
        </Alert>
      </Snackbar>
    </div>
