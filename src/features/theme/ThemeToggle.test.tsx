...
describe("ThemeToggle", () => {
  it("should call toggleTheme on click", () => {
    ...
    const { getByRole } = render(<ThemeToggle darkMode={true} toggleTheme={toggleTheme} />);
  ...
  it("should render different icons for dark/light mode", () => {
    const { container: dark } = render(<ThemeToggle darkMode={true} toggleTheme={jest.fn()} />);
    const { container: light } = render(<ThemeToggle darkMode={false} toggleTheme={jest.fn()} />);
