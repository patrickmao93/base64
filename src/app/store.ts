import { Action, configureStore, getDefaultMiddleware, Update } from "@reduxjs/toolkit";
import { createTransform, PERSIST, PersistConfig, persistReducer, persistStore } from "redux-persist";
import storage from "redux-persist/lib/storage";
import { ThunkAction } from "redux-thunk";
import { Repo, reposAdapter, ReposState, updateAll } from "../features/repos/reposSlice";
...
const persistedReducer = (persistReducer(persistConfig, rootReducer) as unknown) as RootReducerType;
