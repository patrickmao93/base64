import { Box, Fade, IconButton, makeStyles, Paper, Tooltip, Typography } from "@material-ui/core";
  ...
  return (
    <Fade in>
      <Box className={classes.root}>
        <Typography variant="h5">Monitor GitHub repositories for new releases</Typography>
        <Box>
          ...
          <Paper className={classes.action} elevation={3}>
            ...
            <Tooltip title="Add example repositories">
              <span>
                <IconButton color="inherit" onClick={addExamples} disabled={!online}>
                  <PlaylistAddIcon />
                </IconButton>
              </span>
            </Tooltip>
        ...
        <ol className={classes.list}>
          ...
          <li className={classes.listItem}>Visit this page to see what's new</li>
        </ol>
        <Typography variant="h6" className={classes.info} noWrap>
          Note:
        </Typography>
        <Typography variant="body1">
          Your data is stored in your browser's local storage. Only you can access it.
        </Typography>
      </Box>
    </Fade>
  );
