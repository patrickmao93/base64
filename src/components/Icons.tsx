...
export const ExpandMoreIcon = createSvgIcon(<path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z" />, "ExpandMore");
...
export const SortIcon = createSvgIcon(<path d="M3 18h6v-2H3v2zM3 6v2h18V6H3zm0 7h12v-2H3v2z" />, "Sort");
