...
describe("Markdown", () => {
  it("should render markdown", () => {
    const { getByText, container } = render(<Markdown markdown={markdown} repoID="test" />);
  ...
  it("should render links correctly", () => {
    const { container } = render(<Markdown markdown={markdown} repoID="test" />);
  ...
  it("should convert pull numbers to links", () => {
    const { container } = render(<Markdown markdown={markdown} repoID="test" />);
    const link = container.querySelector("a[href='https://github.com/test/pull/123");
    expect(link).toBeInTheDocument();
