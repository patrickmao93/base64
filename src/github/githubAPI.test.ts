...
describe("githubAPI", () => {
  ...
  describe("latestRelease", () => {
    ...
    it("should return error on 404", async () => {
      ...
      await expect(getLatestRelease("something")).rejects.toThrow("does not exist");
    });
  });
  ...
  describe("searchRepos", () => {
    it("should return correct result", async () => {
      ...
      expect(repos).toEqual(["reduxjs/redux", "StephenGrider/ReduxSimpleStarter", "StephenGrider/ReduxCasts"]);
    });
